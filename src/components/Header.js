    ...
    <header className='header-upper py-3'>
      <div className='container-xxl'>
        <div className='row align-items-center'>
          <div className='col-2'>
            <h3>
              <Link className='text-white'><img src={logo} className='sitelogo' alt='logo' /></Link>
            </h3>
          </div>
          <div className='col-5'>
            <div className="input-group">
              <input type="text" className="form-control py-2" placeholder="Search products here.." aria-label="Recipient's username" aria-describedby="basic-addon2" />
          ...
          <div className='col-5'>
            <div className='header-upper-links d-flex align-items-center justify-content-between'>
              ...
              <div>
                <Link to={userState?.user === null ? '/login' : '/my-profile'} className='d-flex align-items-center gap-10 text-white'>
                  <img src={user} alt='' />
                  {
                    userState?.user === null ?
                      <p className='mb-0'>
              ...
              <div>
                <Link to='cart' className='d-flex align-items-center gap-10 text-white'>
                  ...
                  <div className='d-flex flex-column gap-10'>
                    <span className='badge bg-white text-dark'>{totalCount}</span>
                    <p className='mb-0'>Rs {totalAmount}</p>
                  </div>
                </Link>
              </div>
            </div>
            ...
            <div className='menu-bottom d-flex align-items-center gap30'>
              <div>
                <div className="dropdown">
                  <button className="btn btn-secondary dropdown-toggle bg-transparent border-0 gap15 d-flex align-items-center" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
